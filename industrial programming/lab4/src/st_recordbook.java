...
public class st_recordbook implements Comparable<st_recordbook> {
    ...
    public st_recordbook() {
        this.number_of_recordbook = 0;
        this.name_of_student = "";
        this.number_of_sessions = 0;
    }

    public st_recordbook(int number_of_recordbook) {
        this();
        this.number_of_recordbook = number_of_recordbook;
    }

    public st_recordbook(String name_of_student) {
        this();
        this.name_of_student = name_of_student;
    }

    public int get_zachetka() {
    ...
    public static class session {
        ...
        private ArrayList<zachet> zachets = new ArrayList<>();
